    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 border border-white/30 text-white rounded-md hover:bg-red-700/40"
            >
              Reset
            </button>
          </div>
      ...
      <div className="glass p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <p className="text-sm text-red-200">Total GP</p>
            <p className="text-lg font-semibold text-white">
              ₨{totalGP.toLocaleString()}
            </p>
          </div>
          <div>
            <p className="text-sm text-red-200">Total NSR</p>
            <p className="text-lg font-semibold text-white">
              ₨{totalNSR.toLocaleString()}
            </p>
          </div>
          <div>
            <p className="text-sm text-red-200">Overall GP % NSR</p>
            <p className="text-lg font-semibold text-white">
              {overallGPPercent.toFixed(0)}%
            </p>
          </div>
          <div>
            <p className="text-sm text-red-200">Expected Volume (UC)</p>
            <p className="text-lg font-semibold text-white">
